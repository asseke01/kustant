...
(function (halyk) {
    ...
    function pay(params) {
        location.href = halyk.Config().pageUrL + "?params=" + LZString.compressToEncodedURIComponent(encodeParams(params));
    }
    ...
    function onCommandRecieved(evnt) {
        if (evnt.origin.indexOf(halyk.Config().origin) === 0) {
